...
class AuteurRepository extends ServiceEntityRepository
{
    ...
    {
        return $this->createQueryBuilder('a') // SELECT * FROM auteur a
            ...
            ->orWhere('a.pseudo LIKE :searchValue') // OR a.pseudo LIKE '%searchValue%'
            ->orderBy('a.nom', 'ASC') // ORDER BY a.nom ASC
